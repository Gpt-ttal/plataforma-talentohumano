...
export function eliminarLeccionCurso(deps: { repo: CursoRepo }) {
  return async (
    actor: Usuario,
    cursoId: string,
    moduloId: string,
    ...
    exigirRol(actor, [...ROLES_GESTORES], "Solo gestores pueden eliminar lecciones.")
    ...
    return deps.repo.eliminarLeccion(cursoId, leccionId)
  }
}
