 ...
 * El padre (`VacanteDetallePage`) solo monta este editor cuando
    ...
    <div className="mt-3 space-y-3 rounded-lg border border-silver-300 p-3 dark:border-border">
      <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
        <label className={labelCls}>
          <span className={labelTextCls}>Cédula</span>
          <input
            value={cedula}
            maxLength={20}
        ...
        <label className={labelCls}>
          <span className={labelTextCls}>Fecha de contratación</span>
          <input
            type="date"
